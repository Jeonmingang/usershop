...
sm.setOwningPlayer(Bukkit.getOfflinePlayer(oe.owner));
sm.setDisplayName(color("&e" + oe.name));
java.util.List<String> lore = java.util.Arrays.asList(color("&7클릭 시 상점 열기"));
sm.setLore(lore);
